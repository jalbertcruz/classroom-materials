...
${OBJECTDIR}/_ext/148389968/JuegoPong.o: ../Ejercicio2/JuegoPong.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/148389968/JuegoPong.o ../Ejercicio2/JuegoPong.cpp

${OBJECTDIR}/_ext/148389968/Jugador.o: ../Ejercicio2/Jugador.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/148389968
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/148389968/Jugador.o ../Ejercicio2/Jugador.cpp

${OBJECTDIR}/_ext/148389968/Pelota.o: ../Ejercicio2/Pelota.cpp 
	${MKDIR} -p ${OBJECTDIR}/_ext/148389968
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/_ext/148389968/Pelota.o ../Ejercicio2/Pelota.cpp
